  ...
  const faqs = [
    {
      ...
      answer: "Parents mark when their child leaves for school using the mobile app. Teachers then confirm the child's arrival at school. This dual-verification system ensures complete transparency and safety. Parents receive instant notifications when their child arrives safely."
    },
    {
      question: "Is my child's data secure?",
      answer: "Absolutely. We use bank-level encryption to protect all data. Only authorized school staff and parents have access to relevant information. We comply with all data protection regulations and never share personal information with third parties."
    },
    {
      question: "What if there's a mismatch in attendance?",
      answer: "If a parent marks their child as \"left for school\" but the teacher marks them absent, the system immediately alerts both parties. This helps identify potential safety issues quickly and ensures no child goes unaccounted for."
    },
    {
      question: "Can I communicate directly with teachers?",
      answer: "Yes! KidSafe includes a built-in messaging system for praise, concerns, and general communication. Teachers can send praise for good behavior, and parents can raise concerns or ask questions. All communication is logged and accessible to relevant parties."
    },
    {
      question: "How much does KidSafe cost?",
      answer: "KidSafe offers flexible pricing plans for schools of all sizes. We provide a 30-day free trial with no credit card required. Contact our sales team for detailed pricing information tailored to your school's needs."
    },
    {
      question: "Do you provide training and support?",
      answer: "Yes! We provide comprehensive onboarding, training sessions for staff and parents, and 24/7 customer support. Our team ensures smooth implementation and ongoing success with the platform."
    },
    {
      question: "Can parents access the system on mobile devices?",
      answer: "Absolutely! KidSafe is fully responsive and works perfectly on smartphones, tablets, and computers. We also offer dedicated mobile apps for iOS and Android for the best user experience."
    },
    {
      question: "What happens if a parent forgets to mark departure?",
      answer: "The system sends gentle reminders to parents. If a child arrives at school but wasn't marked as departed, teachers can still mark them present, and parents receive a notification to confirm the child's safe arrival."
    }
  ];
